#!/usr/bin/env python3
"""Benchmark OpenAI models for ranker tasks."""
...
def main():
    try:
        ...
        print("Add it to config.yaml or set OPENAI_API_KEY environment variable")
        return
    ...
    # Save results
    output_file = Path(__file__).parent.parent / "results" / "openai_results.json"
